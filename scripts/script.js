...
(async () => {
  const searchElement = '#side > div:first-of-type > div > div:nth-of-type(2) > div:nth-of-type(2) > div > div:first-of-type > p';
  const writeElement = '#main > footer > div:first-of-type > div > span:nth-of-type(2) > div > div:nth-of-type(2) > div:first-of-type > div:nth-of-type(2) > div:first-of-type > p';
  const resultsElement = '#pane-side > div:first-of-type > div > div';
  const firstResultElement = '#pane-side > div:first-of-type > div > div > div:first-of-type';
  try {
